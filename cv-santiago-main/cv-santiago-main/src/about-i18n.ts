...
export const aboutContent = {
  es: {
    ...
    seo: {
      ...
      description: 'Head of Applied AI. Creador de Career-Ops (37.6K+ ⭐ en GitHub). Construye sistemas IA en producción. Fundador de Santifer iRepair (30.000+ reparaciones, exit 2025).',
    },
    ...
    subtitle: 'Applied AI Operator · Founder · Builder of Career-Ops (37.6K+ ⭐)',
  ...
  en: {
    ...
    seo: {
      title: 'Santiago Fernández de Valderrama | Head of Applied AI · Builder of Career-Ops',
      description: 'Head of Applied AI. Creator of Career-Ops (37.6K+ ⭐ on GitHub). Builds production AI systems. Founded Santifer iRepair (30,000+ repairs, exit 2025).',
    },
    heading: 'Santiago Fernández de Valderrama',
    manifesto: 'Companies use AI to filter candidates. I just gave candidates AI to choose companies.',
    subtitle: 'Applied AI Operator · Founder · Builder of Career-Ops (37.6K+ ⭐)',
    ...
    bio: [
      ...
      'Builds production AI systems: Career-Ops (multi-agent job search system, 37.6K+ GitHub stars), a Self-Healing Chatbot with 71 automated evals and 6-layer jailbreak defense, the omnichannel AI agent Jacobo (n8n + ElevenLabs + tool calling, sold with the business), and a custom Business OS with 12 Airtable bases and 2,100 fields.',
